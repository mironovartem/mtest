        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                if message:
                    ...
                    send_mail('Заявка на консультацию', 'Контактные данные:  ' + message +', '+ 'Имя: '+ сontact_name+','+' Самара: ' + str(location_samara) + ', '+' Online: ' + str(location_online), 'admin@testege.com', ['creativerror@gmail.com'] )
